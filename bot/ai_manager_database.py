"""AI Manager MongoDB — same cluster as moderation/dashboard (MONGO_URI_MOD / MONGO_URI).
Revenue stays on its own cluster (MONGO_URI_REVENUE).
"""
...
# Same DB as moderation / mongo_bridge
MONGO_URI = (
    os.getenv("MONGO_URI_MOD")
    or os.getenv("MONGO_URI")
    or os.getenv("MONGODB_URL")
)
MONGO_DB = os.getenv("MONGO_DB_MOD") or os.getenv("MONGO_DB", "bunnydb")
